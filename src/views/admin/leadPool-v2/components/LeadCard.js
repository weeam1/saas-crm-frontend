...
const LeadCard = ({
      ...
      <HStack align="start" spacing={1} w="100%" h="calc(100% - 30px)">
        <VStack align="start" spacing={1} flex="2" minWidth="0" h="100%">
          ...
          <VStack align="start" spacing={0} flex="1" minW={0}>
              ...
              <Text fontSize="10px" color="#FFBB00" fontWeight='bold' fontFamily="DM Sans">
                {sourceContent || "N/A"}
              </Text>
            </VStack>
            <VStack align="start" spacing={0} flex="1" minW={0}>
              ...
              <Text fontSize="10px" color="#32BD00" fontWeight='bold' fontFamily="DM Sans">
                {timetocall || "N/A"}
              </Text>
            </VStack>
  ...
  <InfoPair
    label="City"
    value={<Text fontWeight="bold" fontFamily="DM Sans">{city || "N/A"}</Text>}
  />
  <InfoPair
    label="Country"
    value={<Text fontWeight="bold" fontFamily="DM Sans">{nationality || "N/A"}</Text>}
  />
</VStack>
