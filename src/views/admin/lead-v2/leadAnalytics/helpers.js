...
export const analyticsColumnDescriptions = {
	...
	dealConversionRate:
		'Success rate: percentage of leads that converted to deals (Deals / Total Leads × 100).',
	avgNotesPerLead:
		'Average number of notes per lead, indicating engagement level (Total Notes / Total Leads x 100).',
	newLeadsToday: 'Leads added in the last 24 hours.',
	newLeadsThisWeek: 'Leads added since the start of the current week.',
	newLeadsThisMonth: 'Leads added since the start of the current month.',
