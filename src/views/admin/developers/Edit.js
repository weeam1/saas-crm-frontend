							...
							<Grid templateColumns={{ base: '1fr', md: '1fr 1fr' }} gap={5}>
										...
										{previewImage ? (
											...
											<Center flexDirection='column'>
												<Icon
													...
													mb={3}
												/>
												<Text color={mc.bodyText} mb={2} fontWeight='medium'>
													{isDragActive
														? 'Drop the image here'
														: 'Drag & drop image here, or click to select'}
												</Text>
								...
								<GridItem colSpan={{ base: 1, md: 2 }}>
									...
									<Input
										...
										bg={mc.bgInput}
										borderColor={
											errors.trn && touched.trn ? 'red.300' : mc.borderColor
										}
										color={mc.headingText}
										_hover={{
											borderColor:
												errors.trn && touched.trn ? 'red.300' : mc.borderFocus,
										}}
										_focus={{
											borderColor:
												errors.trn && touched.trn ? 'red.300' : mc.borderFocus,
								...
								<GridItem>
									...
									<Input
										...
										bg={mc.bgInput}
										borderColor={
											errors.email && touched.email ? 'red.300' : mc.borderColor
										}
										color={mc.headingText}
										_hover={{
											borderColor:
								...
								{role === 'superAdmin' && (
									<GridItem>
										...
										<Select
											...
											color={values.agency ? mc.headingText : mc.mutedText}
											_hover={{
												borderColor:
													errors.agency && touched.agency
														? 'red.300'
										...
										{isAgenciesLoading && (
											<Text fontSize='xs' color={mc.mutedText} mt={1}>
												Loading agencies...
											</Text>
										)}
										{isAgenciesError && (
