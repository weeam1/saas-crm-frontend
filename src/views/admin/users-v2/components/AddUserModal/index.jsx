...
// 					<Progress
// 						value={(step / totalSteps) * 100} // this controls progress!
// 						max={100} // optional
// 						colorScheme='green'
// 						height='6px'
// 						borderRadius='full'
...
// 									>
// 										<Text fontSize='xx-small' color='white' fontWeight='bold'>
// 											{i + 1}
// 										</Text>
// 									</Box>
// 								))}
	...
	return (
		<>
			...
			>
				<Box px={6} pt={4}>
					<Flex justify='space-between' mt={2}>
						<Heading size='xs' color={colors.mutedText}>
							Step {step} of {totalSteps}
						</Heading>

						<Heading size='xs' color={colors.bodyText}>
							{step === 1 && 'Personal Information'}
							{step === 2 && 'Identification & Address'}
							{step === 3 && 'Salary & Role Structure'}
						</Heading>
				...
				>
					...
					>
						<Flex align='center' justify='space-between'>
							<Heading size='md' color={colors.headerText}>
								{mode === 'add' ? 'Add New User' : 'Edit User'}
							</Heading>
							<ModalCloseButton
								position='static'
					...
					<ModalBody p={0}>
						<form onSubmit={formik.handleSubmit}>
							<Flex direction={{ base: 'column', lg: 'row' }} gap={6} p={6}>
								{/* Personal Information */}
								{step === 1 && (
									<Box bg={colors.bgInput} borderRadius='lg' p={5} mb={6} w='100%' border="1px solid" borderColor={colors.borderColor}>
										<Flex align='center' gap={2} mb={4}>
											<FaUser color={colors.accentGold} />
											<Heading size='sm' color={colors.headingText}>
												Personal Information
											</Heading>
										</Flex>
								...
								{step === 2 && (
									<Flex direction={'column'} w='100%'>
										<Box bg={colors.bgInput} borderRadius='lg' p={5} mb={6} w='100%' border="1px solid" borderColor={colors.borderColor}>
											<Flex align='center' gap={2} mb={4}>
												<HiIdentification color={colors.accentGold} />
												<Heading size='sm' color={colors.headingText}>
													Identification
												</Heading>
											</Flex>
										...
										<Box bg={colors.bgInput} borderRadius='lg' p={5} w='100%' border="1px solid" borderColor={colors.borderColor}>
											<Flex align='center' gap={2} mb={4}>
												<MdLocationOn color={colors.accentGold} />
												<Heading size='sm' color={colors.headingText}>
													Address & Contact
												</Heading>
											</Flex>
							...
							<Flex align='center' mt={1} gap={2}>
								{Array.from({ length: totalSteps }, (_, i) => (
									<Box
										...
										h={4}
										borderRadius='full'
										bg={step === i + 1 ? colors.accentGold : colors.mutedText}
										display='flex'
										alignItems='center'
										justifyContent='center'
									>
										<Text fontSize='xx-small' color={colors.headerText} fontWeight='bold'>
											{i + 1}
										</Text>
									</Box>
								))}
