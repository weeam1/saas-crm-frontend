...
const UserTable = () => {
	...
	// const gopageValue = jumpPage;
	// const setGopageValue = setJumpPage;
	...
	return (
		<Box px={{ base: 2, md: 6 }} py={{ base: 2, md: 4 }}>
			{/* Header + Action Row */}
			<Flex
					...
					<Table variant='simple' size='md' w='100%'>
						...
						>
							<Tr>
								...
								<Th fontSize='sm' fontWeight='700' color='gray.600' px={3}>
									User
								</Th>
								<Th fontSize='sm' fontWeight='700' color='gray.600' px={3}>
									Role
										...
										<Td px={3} py={3}>
											<Flex align='center' gap={2}>
												...
												<Box
													...
													borderRadius='full'
													bg={
														user.status === 'online' ? 'green.400' : 'gray.400'
													}
												/>
												{/* Status text */}
												<Text
											...
											<Flex justify='flex-end' align='center' gap='2px'>
												...
												>
													<IconButton
														...
														size='sm'
														_hover={{ bg: 'gray.100' }}
														onClick={() => setIsViewUserOpen(true)}
													/>
												</Tooltip>
