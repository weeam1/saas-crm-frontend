...
const generatePayslipPDF = async (employeeData, payslipData) => {
    ...
    const generatedDate = new Date(doc.generatedAt).toISOString().split("T")[0];
    const dueDate = new Date(doc.paidAt || doc.generatedAt)
      .toISOString()
      .split("T")[0];
    ...
    element.innerHTML = `
		<div style="border: 1px solid #d7d7d7; height: 100%; padding: 5mm;">
			<div style="border-bottom: 1px solid #d7d7d7; padding: 8px 12px;">
				<div style="width:100%; text-align:center; font-weight:700; font-size:11px; margin-bottom:6px; color:#000000;">Staff Payslip</div>
				...
				<div style="display:flex; justify-content:space-between; align-items:flex-start; gap:12px; margin-bottom:12px;">
					...
					<div style="text-align:right; font-size:10px; color:#000000;">
						<div style="font-weight:700; font-size:11px;">PAYSLIP: ${doc.payslipId}</div>
						<div style="margin-top:4px;">Date: <span style="font-weight:600;">${generatedDate}</span></div>
						<div>Date Due: <span style="font-weight:600;">${dueDate}</span></div>
					</div>
				</div>
				...
				<div style="display:flex; justify-content:space-between; margin-top:8px; padding:8px 0; border-top:1px solid #f0f0f0;">
					<div style="font-size:10px; color:#000000;">
						...
						<div>Employee ID: ${userData?._id?.slice(5) || "N/A"}</div>
			...
			<!-- Performance & Loan Summary Section -->
			<div style="margin: 12px; display: grid; grid-template-columns: 1fr; gap: 12px;">
				<!-- Performance Summary -->
					<table style="width:100%; border-collapse:collapse; font-size:10px; border-bottom: 1px solid #d7d7d7;">
						<thead>
							<tr>
								<th style="text-align:left; padding:8px 6px; border-bottom:2px solid #d7d7d7; color:#000000; font-weight:700;">Performance Summary</th>
								<th style="text-align:right; padding:8px 6px; border-bottom:2px solid #d7d7d7; color:#000000; font-weight:700;">Amount</th>
							</tr>
						</thead>
						<tbody>
							<tr>
								<td style="padding:8px 6px; border-bottom:1px solid #f2f2f2; color:#000000;font-weight: 700;">Attendance:</td>
								<td style="padding:8px 6px; text-align:right; border-bottom:1px solid #f2f2f2; color:#000000;">${attendanceSummary.totalPresent || 0} Present, ${attendanceSummary.totalLate || 0} Late</td>
							</tr>
							<tr>
								<td style="padding:8px 6px; border-bottom:1px solid #f2f2f2; color:#000000;font-weight: 700;">Closed Deals:</td>
								<td style="padding:8px 6px; text-align:right; border-bottom:1px solid #f2f2f2; color:#000000;">${closeDeals.dealsCount || 0} (${formatCurrencyValue(closeDeals.totalAmount || 0, doc.currency)})</td>
							</tr>
							<tr>
								<td style="padding:8px 6px; border-bottom:1px solid #f2f2f2; color:#000000;font-weight: 700;">Evaluation Score:</td>
								<td style="padding:8px 6px; text-align:right; border-bottom:1px solid #f2f2f2; color:#000000;">${evaluation.finalPercentage || 0}%</td>
							</tr>
						</tbody>
					</table>
				...
				<!-- Loan Summary -->
					<table style="width:100%; border-collapse:collapse; font-size:10px; border-bottom: 1px solid #d7d7d7;">
						<thead>
							<tr>
								<th style="text-align:left; padding:8px 6px; border-bottom:2px solid #d7d7d7; color:#000000; font-weight:700;">Loan Summary</th>
								<th style="text-align:right; padding:8px 6px; border-bottom:2px solid #d7d7d7; color:#000000; font-weight:700;">Amount</th>
							</tr>
						</thead>
						<tbody>
							<tr>
								<td style="padding:8px 6px; border-bottom:1px solid #f2f2f2; color:#000000;font-weight: 700;">Total Borrowed:</td>
								<td style="padding:8px 6px; text-align:right; border-bottom:1px solid #f2f2f2; color:#000000;">${formatCurrencyValue(loanSummary.totalBorrowedAmount || 0, doc.currency)}</td>
							</tr>
							<tr>
								<td style="padding:8px 6px; border-bottom:1px solid #f2f2f2; color:#000000;font-weight: 700;">Remaining:</td>
								<td style="padding:8px 6px; text-align:right; border-bottom:1px solid #f2f2f2; color:#000000;">${formatCurrencyValue(loanSummary.totalRemainingAmount || 0, doc.currency)}</td>
							</tr>
							<tr>
								<td style="padding:8px 6px; border-bottom:1px solid #f2f2f2; color:#000000;font-weight: 700;">Monthly Installment:</td>
								<td style="padding:8px 6px; text-align:right; border-bottom:1px solid #f2f2f2; color:#000000;">${formatCurrencyValue(loanSummary.monthlyInstallment || 0, doc.currency)}</td>
							</tr>
						</tbody>
					</table>
			</div>
			...
			<div style="margin: 0 12px 12px 12px;">
				<table style="width:100%; border-collapse:collapse; font-size:10px; border-bottom: 1px solid #d7d7d7;">
					...
					<tbody>
						<tr>
							<td style="padding:8px 6px; border-bottom:1px solid #f2f2f2; color:#000000;font-weight: 700;">Basic Salary</td>
						...
						<tr>
							<td style="padding:8px 6px; border-bottom:1px solid #f2f2f2; color:#000000;font-weight: 700;">Attendance Salary</td>
						...
						<tr>
							<td style="padding:8px 6px; border-bottom:1px solid #f2f2f2; color:#000000;font-weight: 700;">Commission</td>
						...
						<tr>
							<td style="padding:8px 6px; border-bottom:1px solid #f2f2f2; color:#000000;font-weight: 700;">Incentive</td>
			...
			<div style="margin: 0 12px 12px 12px;">
				<table style="width:100%; border-collapse:collapse; font-size:10px; border-bottom: 1px solid #d7d7d7;">
					...
					<tbody>
						<tr>
							<td style="padding:8px 6px; border-bottom:1px solid #f2f2f2; color:#000000;font-weight: 700;">Loan Deduction</td>
						...
						<tr>
							<td style="padding:8px 6px; font-weight:700; border-bottom:2px solid #d7d7d7; color:#000000;">Total Deductions</td>
			...
			<div style="margin: 12px; padding: 12px; border: 1px solid #d7d7d7; border-radius: 4px; background-color: #f9f9f9;">
				...
				<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px; font-size: 9px;">
					<div>
						<div style="font-weight: 600; color: #000000;">Basic Salary: ${formatCurrencyValue(payrollCalculation.basicSalary || 0, doc.currency)}</div>
						<div style="font-weight: 600; color: #000000;">Attendance Adjusted: ${formatCurrencyValue(payrollCalculation.attendanceAdjustedSalary || 0, doc.currency)}</div>
						<div style="font-weight: 600; color: #000000;">Commission: ${formatCurrencyValue(payrollCalculation.commissionEarned || 0, doc.currency)}</div>
					</div>
					<div>
						<div style="font-weight: 600; color: #000000;">Incentive: ${formatCurrencyValue(payrollCalculation.incentiveEarned || 0, doc.currency)}</div>
						<div style="font-weight: 600; color: #000000;">Loan Deduction: ${formatCurrencyValue(deductions?.loanDeduction || 0, doc.currency)}</div>
						<div style="font-weight: 600; color: #000000;">Net Pay: ${formatCurrencyValue(netSalary, doc.currency)}</div>
					</div>
				</div>
			</div>
