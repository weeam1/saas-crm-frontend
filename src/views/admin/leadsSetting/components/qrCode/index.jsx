...
const QRSettings = () => {
  ...
  if (isLoadingTemplates && !englishPdf && !arabicPdf) {
    return (
      <Box w="100%" p={6} textAlign="center" bg={colors.bgDeep} minH="100vh">
        <Spinner size="xl" color={colors.accentGold} />
        <Text mt={4} color={colors.bodyText}>
          Loading templates...
        </Text>
      </Box>
    );
  ...
  return (
    <Box w="100%" p={6} bg={colors.bgDeep} minH="100vh">
      <AppButton
        mb="3"
        ...
        >
          <HStack spacing={3}>
            <Flex
              ...
              justify="center"
            >
              <Icon as={FaQrcode} boxSize="24px" color={colors.accentGold} />
            </Flex>
            <VStack align="start" spacing={0}>
              <Heading size="lg" color={colors.headingText} fontWeight="700">
                Invitation PDFs
              </Heading>
              <Text color={colors.bodyText} fontSize="sm">
                Upload English and Arabic PDF files for lead invitations
              </Text>
            </VStack>
          </HStack>
        ...
        <Box p={6}>
          <VStack spacing={6} w="100%">
            ...
            <Box
              ...
              p={6}
              border="2px dashed"
              borderColor={englishPdf ? colors.accentGold : colors.borderColor}
              transition="all 0.3s"
            >
              <VStack spacing={4} w="100%">
                <HStack w="100%" justify="space-between">
                ...
                {!englishPdf ? (
                  <VStack spacing={4} w="100%">
                    <Flex
                      ...
                      justify="center"
                    >
                      <Icon as={FaFilePdf} boxSize="40px" color={colors.accentGold} />
                    </Flex>
                    <VStack spacing={2}>
                      <Text color={colors.headingText} fontSize="lg" fontWeight="600">
                        Upload English PDF
                      </Text>
                      <Text color={colors.bodyText} fontSize="sm" textAlign="center">
                        Click to upload your English PDF file
                        <br />
                        (Max size: 10MB)
                      </Text>
                    ...
                    >
                      <HStack spacing={4}>
                        <Flex
                          ...
                          justify="center"
                        >
                          <Icon as={FaFilePdf} boxSize="30px" color={colors.accentGold} />
                        </Flex>
                        <VStack align="start" spacing={1}>
                          <Text
                      ...
                      <HStack spacing={2}>
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={handleDownloadEnglish}
                          isDisabled={!englishPdf?.serverFilename || isDownloadingEnglish}
                          isLoading={isDownloadingEnglish}
                          loadingText="Downloading..."
                          _hover={{
                            bg: `rgba(212, 175, 55, 0.1)`,
            ...
            <Box
              ...
              p={6}
              border="2px dashed"
              borderColor={arabicPdf ? colors.accentGold : colors.borderColor}
              transition="all 0.3s"
            >
              <VStack spacing={4} w="100%">
                <HStack w="100%" justify="space-between">
                    ...
                    >
                      ...
                      <HStack spacing={2}>
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={handleDownloadArabic}
                          isDisabled={!arabicPdf?.serverFilename || isDownloadingArabic}
                          isLoading={isDownloadingArabic}
                          loadingText="Downloading..."
                          _hover={{
                            bg: `rgba(212, 175, 55, 0.1)`,
          ...
          {bothFilesUploaded && (
            <Flex
              ...
              borderColor={colors.badgeSuccessBorder}
            >
              <Text color={colors.badgeSuccessText} fontSize="sm" fontWeight="500">
                ✓ Both PDF files are ready. They will be used for lead
                invitations based on lead's language preference when status is
                "Will Attend".
              </Text>
