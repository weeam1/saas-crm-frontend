...
// const MetaIdTab = ({ metaIds, isLoading, onAdd, onEdit, onDelete }) => {
...
//     () => [
//       { Header: "Meta ID / Key", accessor: "key", width: 200 },
...
//             ) : [].length > 0 ? (
//               metaIds.map((metaId) => (
//                 <Tr key={metaId.id} _hover={{ bg: hoverBg }}>
...
const MetaIdTab = ({ metaIds, isLoading, onAdd, onEdit, onDelete }) => {
  ...
  const thBg = useColorModeValue("brand.200", "gray.700");
  const borderColor = useColorModeValue("gray.200", "gray.700");
  console.log(metaIds, "meta ids in tab");
  const columns = useMemo(
    () => [
      { Header: "Meta ID / Key", accessor: "key", width: 200 },
      { Header: "Description", accessor: "description", width: 400 },
