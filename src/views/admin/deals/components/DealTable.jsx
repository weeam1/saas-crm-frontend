...
const DealTable = ({
	...
	useEffect(() => {
		const timer = setTimeout(() => setTableLoading(false), 1000);
		return () => clearTimeout(timer);
	}, []);
	...
	return (
		...
		>
			<Table variant='simple' size='md'>
				<Thead position='sticky' top={0} bg='bg.elevated' zIndex={1}>
					<Tr>
						{columns.map((header, index) => (
							<Th
								key={index}
						...
						data.map((deal, i) => (
							...
							>
								...
								<Td
									...
									fontWeight='medium'
								>
									{deal.manager?.fullName || 'No Manager'}
								</Td>
								...
								<Td
									...
									fontWeight='medium'
								>
									{deal.agent?.fullName || 'No Agent'}
								</Td>

								<Td textAlign='center' minWidth='150px' color='text.body'>
									{deal.projectName || 'N/A'}
								</Td>

								<Td textAlign='center' color='text.body'>
									{deal.unitNumber || 'N/A'}
								</Td>

								<Td textAlign='center' minW='120px' color='text.body'>
									{deal.unitType || 'N/A'}
								</Td>
								...
								<Td textAlign='center' minW='200px' color='text.body'>
									{deal?.closedBy?.fullName || 'N/A'}
								</Td>
								...
								<Td textAlign='center' minW='50px'>
									<Badge
										variant={
											deal.dealStatus === 'Confirmed' ? 'gold' : 'subtle'
										}
										borderRadius='full'
										px={3}
										py={1}
								...
								<Td textAlign='center' minW='50px'>
									<Badge
										variant={deal.spaDone ? 'gold' : 'subtle'}
										borderRadius='full'
										px={3}
										py={1}
										fontSize='11px'
								...
								<Td textAlign='center' minW='80px'>
									<HStack spacing={2} justify='center'>
										<Badge
											variant={deal.invoiceSent ? 'gold' : 'subtle'}
											borderRadius='full'
											px={3}
											py={1}
											fontSize='11px'
