...
export default function CheckTable(props) {
	...
	const [view, setView] = useState(() => {
		return localStorage.getItem('developersView') || 'table';
	});
	...
	const handleViewChange = (newView) => {
		setView(newView);
		localStorage.setItem('developersView', newView);
	};
	return (
		<>
			...
			<Box direction='column' w='100%'>
				...
				>
					<Flex align='center' flexWrap='wrap' gap={2}>
						<Text color={'text.heading'} fontSize='20px' fontWeight='bold'>
