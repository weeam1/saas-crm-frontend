  ...
  return (
    <>
          ...
          <Flex alignItems="center">
            ...
            {selectedHeadings.length > 0 && (
              <Button
                color="red"
                ml="2"
                onClick={() => setDeleteManyHeadings(true)}
                size="sm"
              >
                <DeleteIcon />
              </Button>
      ...
      <DeleteFiled
        method="many"
        isOpen={deleteMany}
        onClose={setDeleteMany}
        url={"api/custom-field/deleteMany"}
        moduleName={moduleName}
        moduleId={data[0]?._id}
        selectedId={selectedId}
        fetchData={fetchData}
      ...
      <DeleteHeading
        method="one"
        isOpen={deleteHeadingModal}
        onClose={setDeleteHeadingModal}
        moduleName={moduleName}
        moduleId={data[0]?._id}
        selectedId={selectedHeadingId}
        fetchData={fetchData}
        updateFiled={updateHeading}
      />
      <DeleteHeading
        method="many"
        isOpen={deleteManyHeadings}
        onClose={setDeleteManyHeadings}
        url={"api/custom-field/deleteMany-headings"}
        moduleName={moduleName}
        moduleId={data[0]?._id}
        selectedId={selectedHeadingId}
        fetchData={fetchData}
        updateFiled={updateHeading}
        setSelectedValues={setSelectedHeadings}
        data={selectedHeadings}
      />
    </>
  );
};
