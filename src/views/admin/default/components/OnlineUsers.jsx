...
const OnlineUsers = () => {
	...
	// Using your theme's semantic tokens
	const cardBg = 'bg.surface';
	const hoverBg = 'bg.elevated';
	...
	return (
		...
		>
			...
			<Flex align='center' justify='space-between' mb={4}>
				<Flex align='center' gap={3}>
					<Icon as={FaUsers} boxSize={5} color='text.accent' />
					<Text fontWeight='semibold' color='text.heading'>
						Online Users
					</Text>
				</Flex>

				<Badge variant='gold' borderRadius='full' px={3} py={1} fontSize='xs'>
					<Flex align='center' gap={2}>
						...
						/>
						{isLoading ? (
							<Spinner size='xs' color='text.accent' />
						) : (
							`${onlineCount} Live`
						)}
					</Flex>
