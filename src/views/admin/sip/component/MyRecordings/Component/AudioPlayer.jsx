    ...
    >
      ...
      <Flex align="center" gap={4}>
        <IconButton
          ...
          icon={
            loading ? (
              <Spinner size="xs" color={colors.accentGold} />
            ) : error ? (
              <FaPlay />
            ) : isPlaying ? (
              <FaPause />
        ...
        <Slider
          ...
          colorScheme="yellow"
        >
          <SliderTrack bg={colors.borderColor}>
            <SliderFilledTrack bg={colors.accentGold} />
          </SliderTrack>
          <SliderThumb boxSize={3} bg={colors.accentGold} />
        </Slider>
      ...
      <Flex justify="space-between" px={10}>
        <Text fontSize="xs" color={colors.accentGold}>
