          ...
          <VStack spacing={4} overflow="scroll" height="65vh">
            <SimpleGrid columns={colSpan} gap={4} w="full">
              <FormControl>
                ...
                <Input
                  value={filters.sipId || ""}
                  onChange={(e) => setFilters({ ...filters, sipId: e.target.value })}
              ...
              <FormControl>
                ...
                <Input
                  ...
                  onChange={(e) => setFilters({ ...filters, extensionId: e.target.value })}
            ...
            <SimpleGrid columns={colSpan} gap={4} w="full">
              <FormControl>
                ...
                <Input
                  value={filters.sipIp || ""}
                  onChange={(e) => setFilters({ ...filters, sipIp: e.target.value })}
              ...
              <FormControl>
                ...
                <Input
                  ...
                  onChange={(e) => setFilters({ ...filters, sipPort: e.target.value })}
            ...
            <FormControl>
              ...
              <Input
                ...
                onChange={(e) => setFilters({ ...filters, sipSimNumber: e.target.value })}
