	...
	const menuItems = [
		{
			...
			route: '/attendence/dashboard',
		},
		{ label: 'Employees', icon: FaUsers, route: '/attendence/employees' },
		{
			label: 'My Attendance',
			icon: FaUserCheck,
			route: '/attendence/my-attendence',
		},
		{ label: 'Records', icon: FaClipboardList, route: '/attendence/records' },
	];
