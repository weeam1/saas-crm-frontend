          ...
          >
            ...
            <Box display="flex" alignItems="center" gap="2" flexWrap="wrap">
              <Menu isLazy>
                ...
                <MenuList minW={"fit-content"} zIndex={100}>
                  <MenuItem
              ...
              {access?.create && (
                ...
                <ViewToggle handleView={handleView} view={view} moduleView="leadViewMode"/>
            </Box>
          </GridItem>
        </Grid>
        {/* Search tags */}
    { getTagValues&&  <Wrap gap="2" my={1}>
          {
                    ...
                    <Tr {...row?.getRowProps()} key={i++} className="leadRow">
                      {row?.cells?.map((cell, index) => {
                        ...
                        if (cell?.column.Header === "#") {
                          ...
                          cell?.column.Header === "Manager Assign Date"
                        ) {
                          data = (
                            <Text
                              fontSize="sm"
                          ...
                          cell?.column.Header === "Agent Assign Date"
                        ) {
                          data = (
                            <Text
                              fontSize="sm"
