...
// // 	// const { isConnected, registerWhatsappUser } = useSocketEvents();
...
// 	useEffect(() => {
// 		if (currentUser?.phoneNumber && user?.tenant?.tenantId) {
// 			setBusinessPhone(currentUser?.phoneNumber);
// 			const registerPayload = {
// 				phoneNumber: currentUser?.phoneNumber,
// 				userId: user?._id || '',
...
// 			if (!businessPhone) {
// 				return toast.error(
// 					'Business Phone number required!, Please try again later.',
// 				);
// 			}
...
// 											Replying to {replyingTo.sender.name}
// 										</Text>
// 										<Text fontSize='sm' isTruncated color={colors.bodyText}>
// 											{replyingTo.text || 'Media message'}
// 										</Text>
// 									</Box>
// 									<IconButton
...
// 												color={colors.mutedText}
// 												variant='ghost'
// 												_hover={{ color: colors.badgeErrorText }}
// 											/>
// 											<IconButton
// 												icon={<RiSendPlaneFill />}
// 												aria-label='Send recording'
...
// 						>
// 							<VStack spacing={4} align='center' textAlign='center'>
// 								<Icon as={FaWhatsapp} boxSize={12} color={colors.mutedText} />
...
// 								<Text fontSize='sm' color={colors.mutedText} maxW='sm'>
// 									Send and receive customer messages directly from WEEAM CRM.
// 								</Text>
// 							</VStack>
// 						</Box>
...
// 						boxShadow={colors.modalShadow}
// 					>
// 						<ModalHeader color={colors.headingText}>Preview</ModalHeader>
// 						{/* <ModalCloseButton color={colors.headingText} /> */}
// 						<ModalBody>
// 							{selectedFile?.type.includes('image') ? (
// 								<>
// 									<Image
	...
	return (
		<>
			...
			>
				...
				{/* Chat Area */}
				<Box flex={1} display='flex' flexDirection='column' bg={colors.bg} h='100%'>
					{activeChat ? (
						<>
							{/* Chat Header */}
							<Flex
							...
							{replyingTo && (
								...
								>
									<Box flex={1}>
										<Text fontSize='sm' color={colors.accentGold}>
											Replying to {replyingTo.sender.name}
										</Text>
										<Text fontSize='sm' isTruncated color={colors.bodyText}>
											{replyingTo.text || 'Media message'}
							...
							>
								...
								<Flex align='center'>
									...
									<Popover placement='top-start' _focus={{ outline: 'none' }}>
										...
										<PopoverContent w='auto' bg={colors.bg} borderColor={colors.borderColor}>
											<PopoverArrow bg={colors.bg} />
											<PopoverBody p={1}>
												<VStack spacing={1} align='stretch'>
													<Button
						...
						>
							<VStack spacing={4} align='center' textAlign='center'>
								...
								<Text fontSize='xl' color={colors.mutedText} fontWeight='semibold'>
									WhatsApp for CRM
								</Text>
