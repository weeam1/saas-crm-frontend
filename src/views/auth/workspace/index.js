...
const handleDeleteWorkspace = (e, workspaceId) => {
	...
	<Box mt={8}>
		...
		<Box maxH='120px' overflowY='auto' pr='4px' sx={{
			'&::-webkit-scrollbar': { width: '4px' },
			'&::-webkit-scrollbar-track': { bg: 'rgba(212,175,55,0.05)', borderRadius: '4px' },
			'&::-webkit-scrollbar-thumb': { bg: C.goldPri, borderRadius: '4px', opacity: 0.5 },
		}}>
					...
					>
						<HStack spacing={3}>
							<Flex
								...
								flexShrink={0}
							>
								<Icon as={FaBuilding} color={C.goldPri} fontSize='12px' />
							</Flex>
